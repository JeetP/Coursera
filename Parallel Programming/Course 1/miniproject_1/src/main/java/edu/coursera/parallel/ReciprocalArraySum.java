...
public final class ReciprocalArraySum {
    ...
    protected static double parArraySum(final double[] input) {
        ...
        // Compute sum of reciprocals of array elements
        double sum = 0;
        ReciprocalArraySumTask upper = new ReciprocalArraySumTask(0,input.length/2,input);
        ReciprocalArraySumTask lower = new ReciprocalArraySumTask(input.length/2,input.length,input);
//        upper.fork();
//        lower.compute();
//        upper.join();
        ForkJoinTask.invokeAll(lower,upper);
